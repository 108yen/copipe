...
export type CopipeWithTagPayload = Prisma.copipeGetPayload<{ select: typeof copipeWithTag }>
...
export type CopipeWithTagCommentPayload = Prisma.copipeGetPayload<{ select: typeof copipeWithTagComment }>
